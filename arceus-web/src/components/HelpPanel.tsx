...
const tabs: Tab[] = [
  ...
  { id: 'ai', label: 'Arceus Ai', icon: <Zap className="h-4 w-4" /> },
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <p style={{ fontSize: 12, color: '#6b7280', margin: 0, lineHeight: 1.6 }}>
          Open the prompt via the <span style={{ color: '#e2e2e8' }}>Arceus Ai</span> button
          (top-right).
        </p>
      </div>
    );
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 12, color: '#6b7280', margin: 0 }}>Arceus — graph explorer</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        >
          <span style={{ fontSize: 11, color: '#4b5563' }}>
            Arceus — open source codebase graph explorer
          </span>
          <a
            href="https://github.com/Sirius6907/Arceus"
            target="_blank"
