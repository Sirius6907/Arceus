...
import { NODE_TABLES, REL_TYPES } from 'arceus-shared';
...
//
// Source locations:
//   validLabel / validRelType  -- arceus-web/src/core/llm/tools.ts
//   isSafeId                   -- arceus-web/src/components/ProcessesPanel.tsx
//   readOnly guard (regex)     -- arceus-web/src/core/lbug/lbug-adapter.ts
// ---------------------------------------------------------------------------
