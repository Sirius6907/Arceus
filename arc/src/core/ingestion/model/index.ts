...
// `SymbolDefinition` moved to `arceus-shared` (RFC #909 Ring 1 #910).
// Consumers should import it directly from `arceus-shared`, not via this barrel.
...
// `MroStrategy` itself lives in `arceus-shared`; re-exported here for
