 ...
 *
 *     arceus-shared (NodeLabel)       — leaf type
 *          ↑
...
import type { NodeLabel, SymbolDefinition } from 'arceus-shared';
...
// `SymbolDefinition` moved to `arceus-shared` as part of RFC #909 Ring 1
// (see #910). It is imported at the top of this file from `arceus-shared`
// and re-used unchanged throughout. Consumers should import
// `SymbolDefinition` directly from `arceus-shared`, not via this file.
