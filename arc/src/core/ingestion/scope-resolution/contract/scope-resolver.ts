 ...
 *      `arc/src/core/ingestion/languages/<lang>/scope-resolver.ts`.
 ...
 *      `arc/src/core/ingestion/scope-resolution/pipeline/registry.ts`
 ...
 *      `arc/test/integration/resolvers/<lang>.test.ts` passes
 ...
 *
 * `arc/src/core/ingestion/languages/python/scope-resolver.ts` —
 ...
 * ## Semantic-model source of truth
 *
 * `ParsedFile` (from `arceus-shared/src/scope-resolution/parsed-file.ts`)
 ...
 *     `arc/src/core/ingestion/call-processor.ts` for the legacy
