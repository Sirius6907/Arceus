 ...
 * recovery hints emitted by `arc` subcommands.
 *
 ...
 * preserves the human-readable contract for users running `arc`
 ...
 * because Arceus CLI tools (`query`, `cypher`, `impact`) emit JSON
