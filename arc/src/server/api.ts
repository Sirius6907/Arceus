...
import { NODE_TABLES, type GraphNode, type GraphRelationship } from 'arceus-shared';
 ...
 */
function mountSSEProgress(app: express.Express, routePath: string, jm: JobManager): void {
  const sseProgressHandler: express.RequestHandler = (req, res) => {
