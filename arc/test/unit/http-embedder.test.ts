...
describe('HTTP embedding backend', () => {
  ...
  describe('MCP embedder', () => {
    ...
    it('returns true when HTTP environment variables are set', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://localhost:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
  ...
  describe('core embedder HTTP path', () => {
    it('sends correct request payload', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
      process.env.ARC_EMBEDDING_API_KEY = 'test-key';
    ...
    it('omits dimensions from request body when ARC_EMBEDDING_DIMS is unset', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
      // ARC_EMBEDDING_DIMS intentionally unset
    ...
    it('forwards ARC_EMBEDDING_DIMS as dimensions in request body', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'text-embedding-3-large';
      process.env.ARC_EMBEDDING_DIMS = '1024';
    ...
    it('forwards dimensions on the single-query path', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'text-embedding-3-large';
      process.env.ARC_EMBEDDING_DIMS = '512';
    ...
    it('excludes API key from error messages', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
      process.env.ARC_EMBEDDING_API_KEY = 'secret-key-12345';
    ...
    it('rejects non-numeric ARC_EMBEDDING_DIMS values', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
      process.env.ARC_EMBEDDING_DIMS = '1024abc';
    ...
    it('throws on dimension mismatch when ARC_EMBEDDING_DIMS is set', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
      process.env.ARC_EMBEDDING_DIMS = '512';
  ...
  describe('dimension mismatch on query path', () => {
    ...
    it('throws with Set hint when ARC_EMBEDDING_DIMS is unset', async () => {
      process.env.ARC_EMBEDDING_URL = 'http://test:8080/v1';
      process.env.ARC_EMBEDDING_MODEL = 'test-model';
      ...
      const { embedText } = await import('../../src/core/embeddings/embedder.js');
      await expect(embedText('test')).rejects.toThrow('Set ARC_EMBEDDING_DIMS=768');
    });
  });
});
