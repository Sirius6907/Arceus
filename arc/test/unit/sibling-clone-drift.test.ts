...
describe('registry persists remoteUrl', () => {
  ...
  beforeEach(async () => {
    tmpHome = await createTempDir('arc-sibling-home-');
    tmpRepo = await createTempDir('arc-sibling-repo-');
    savedHome = process.env.ARC_HOME;
    process.env.ARC_HOME = tmpHome.dbPath;
  });

  afterEach(async () => {
    if (savedHome === undefined) delete process.env.ARC_HOME;
    else process.env.ARC_HOME = savedHome;
...
describe('findSiblingClones', () => {
  ...
  beforeEach(async () => {
    tmpHome = await createTempDir('arc-sibling-find-home-');
    savedHome = process.env.ARC_HOME;
    process.env.ARC_HOME = tmpHome.dbPath;
  });
...
describe('checkCwdMatch', () => {
  ...
  beforeEach(async () => {
    tmpHome = await createTempDir('arc-cwd-match-home-');
    savedHome = process.env.ARC_HOME;
    process.env.ARC_HOME = tmpHome.dbPath;
  });
