## Arceus vendor notice

This directory is a Arceus-managed vendored copy of the official
`tree-sitter-swift@0.7.1` npm runtime package, including its official native
prebuilds. Arceus keeps the top-level `tree-sitter` dependency pinned to
...
Arceus tarball can load `tree-sitter-swift`.
