 ...
 * DAG (`arc/src/core/ingestion/` outside `scope-resolution/`) and
 * the scope-resolution pipeline (`arc/src/core/ingestion/scope-resolution/`).
 ...
 * `ScopeResolver` contract (`arc/src/core/ingestion/scope-resolution/contract/scope-resolver.ts`)
